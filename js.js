document.addEventListener("DOMContentLoaded", function() {
   ...
   //fuction pour fermeture
    ...
    function displayOptions(results, container, containerClass) {
      ...
      // const filterValues = displayFilterValues(results);
      // console.log(filterValues);
      console.log("affiche tableau selection");
    }
    //fuction  de tag de filter pour afficher les cards
    // function displayFilterValues(listItem){
      
    //   listItem.forEach(element => {
    //     filterValues.filtepush(element.value.trim());
    //   });
    //   console.log(filterValues); // Affiche les valeurs dans la console
    //   return filterValues;
    // }
