...
// Créer des ensembles pour stocker les ingrédients et les appareils uniques
const ingredientsUniques = new Set();
const appareilsUniques = new Set();

// Parcourir les résultats filtrés pour extraire les ingrédients et les appareils uniques
resultats.forEach(recipe => {
    recipe.ingredients.forEach(ingredient => ingredientsUniques.add(ingredient.ingredient));
    appareilsUniques.add(recipe.appliance);
});

// Afficher les listes d'ingrédients et d'appareils
...
// Appeler la fonction avec le terme de recherche "caco"
afficherListes(" ");
